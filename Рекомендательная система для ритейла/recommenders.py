...
from implicit.nearest_neighbours import ItemItemRecommender, TFIDFRecommender, BM25Recommender  # нужен для одного трюка
...
class MainRecommender:
    ...
    @staticmethod
    def fit(user_item_matrix, n_factors=30, regularization=0.01, iterations=15, num_threads=4):
        """Обучает ALS"""
